...
def return_code_description(return_code: int) -> str:
    ...
    descriptions = {
        MetaTrader5Constants.TRADE_RETCODE_REQUOTE: "Requote",
        MetaTrader5Constants.TRADE_RETCODE_REJECT: "Request rejected",
        MetaTrader5Constants.TRADE_RETCODE_CANCEL: "Request canceled by trader",
        MetaTrader5Constants.TRADE_RETCODE_PLACED: "Order placed",
        MetaTrader5Constants.TRADE_RETCODE_DONE: "Request completed",
        MetaTrader5Constants.TRADE_RETCODE_DONE_PARTIAL: "Only part of the request was completed",
        MetaTrader5Constants.TRADE_RETCODE_ERROR: "Request processing error",
        MetaTrader5Constants.TRADE_RETCODE_TIMEOUT: "Request canceled by timeout",
        MetaTrader5Constants.TRADE_RETCODE_INVALID: "Invalid request",
        MetaTrader5Constants.TRADE_RETCODE_INVALID_VOLUME: "Invalid volume in the request",
        MetaTrader5Constants.TRADE_RETCODE_INVALID_PRICE: "Invalid price in the request",
        MetaTrader5Constants.TRADE_RETCODE_INVALID_STOPS: "Invalid stops in the request",
        MetaTrader5Constants.TRADE_RETCODE_TRADE_DISABLED: "Trade is disabled",
        MetaTrader5Constants.TRADE_RETCODE_MARKET_CLOSED: "Market is closed",
        MetaTrader5Constants.TRADE_RETCODE_NO_MONEY: "There is not enough money to complete the request",
        MetaTrader5Constants.TRADE_RETCODE_PRICE_CHANGED: "Prices changed",
        MetaTrader5Constants.TRADE_RETCODE_PRICE_OFF: "There are no quotes to process the request",
        MetaTrader5Constants.TRADE_RETCODE_INVALID_EXPIRATION: "Invalid order expiration date in the request",
        MetaTrader5Constants.TRADE_RETCODE_ORDER_CHANGED: "Order state changed",
        MetaTrader5Constants.TRADE_RETCODE_TOO_MANY_REQUESTS: "Too frequent requests",
        MetaTrader5Constants.TRADE_RETCODE_NO_CHANGES: "No changes in request",
        MetaTrader5Constants.TRADE_RETCODE_SERVER_DISABLES_AT: "Autotrading disabled by server",
        MetaTrader5Constants.TRADE_RETCODE_CLIENT_DISABLES_AT: "Autotrading disabled by client terminal",
        MetaTrader5Constants.TRADE_RETCODE_LOCKED: "Request locked for processing",
        MetaTrader5Constants.TRADE_RETCODE_FROZEN: "Order or position frozen",
        MetaTrader5Constants.TRADE_RETCODE_INVALID_FILL: "Invalid order filling type",
        MetaTrader5Constants.TRADE_RETCODE_CONNECTION: "No connection with the trade server",
        MetaTrader5Constants.TRADE_RETCODE_ONLY_REAL: "Operation is allowed only for live accounts",
        MetaTrader5Constants.TRADE_RETCODE_LIMIT_ORDERS: "The number of pending orders has reached the limit",
        MetaTrader5Constants.TRADE_RETCODE_LIMIT_VOLUME: "The volume of orders and positions for the symbol has reached the limit",
    }
